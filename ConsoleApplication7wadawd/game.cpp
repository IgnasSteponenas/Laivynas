...
void game::surasymas(int x, int y, char kryptis, int vieta)
{
	if (vieta == 0)
	{
		if (kryptis == 'v')
...
void game::surasymasBOT(int x, int y, char kryptis, int vieta)
{
	if (vieta == 0)
	{
		if (kryptis == 'v')
...
void game::zaidejoPradiniaiLaivai()
{
	int x;
	int y;
	char kryptis;
...
bool game::statimoTikrinimas(int kiekVietu, char puse, int x, int y)
{
...
bool game::statimoTikrinimasBOT(int kiekVietu, char puse, int x, int y)
{
...
void game::zaidejoLaivuIvedimas(int &x, int &y, char &kryptis, bool reikia)
{
...
void game::numustoLaivoTikrinimas(int x, int y)
{
	for (int i = 0; i < 20; i++)
	{
...
void game::numustoLaivoTikrinimasBOT(int x, int y)
{
	for (int i = 0; i < 20; i++)
	{
